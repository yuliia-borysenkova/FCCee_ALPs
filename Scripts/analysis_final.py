...
processList = {
    ...
    #'wzp6_ee_gammagamma_ecm91':{}, #wzp6_ee_gammagamma_ecm91
...
processLabels = {
    #backgrounds
    #'p8_ee_Zee_ecm91':"Z $\rightarrow$ ee", #Z decays to ee
    #'wzp6_ee_gammagamma_ecm91':"diphoton production",

    #signals
    'process_name': "$m_ALP =$ ALPs_mass GeV, $c_{YY} = ALPs_cYY$",
}
...
procDictAdd={
    "process_name": {"numberOfEvents": num_events, 
    "sumOfWeights": num_events, "crossSection": cross_section_value, 
...
cutList = {
    ...
    "sel0": """
        ...
        return temp(FSGenPhoton_p); """, 
    "sel1": "n_FSGenElectron == 0",
    "sel2": """
        auto temp = [](auto const &vec) -> bool 
        {
            bool rv = true; 
        ...
        return temp(FSGenPhoton_p) && n_FSGenElectron == 0; """,
}

###Dictionary for prettier names of cuts (optional)
cutLabels = {
    "selNone": "Before selection",
    "sel0": "The energy of final state photons > 5 GeV",
    "sel1": "0 final state electrons",
    "sel2": "The energy of final state photons > 5 GeV and 0 final state electrons",
}
...
histoList = {
    ...
    "FSGenPhoton_alpha":               {"name":"FSGenPhoton_alpha",              "title":"Final state gen photons #alpha",             "bin":64, "xmin":-3.2,"xmax":3.2}, #UPDATE
    ...
    "GenZPhoton_e":           {"name":"GenZPhoton_e",            "title":"Gen photon_{0} energy [GeV]",                  "bin":100,"xmin":0 ,"xmax":50}, #UPDATE
    "GenZPhoton_p":           {"name":"GenZPhoton_p",            "title":"Gen photon_{0} p [GeV]",                       "bin":100,"xmin":0 ,"xmax":50}, #UPDATE
    "GenZPhoton_pt":          {"name":"GenZPhoton_pt",          "title":"Gen photon_{0} p_{T} [GeV]",                   "bin":100,"xmin":0 ,"xmax":50}, #UPDATE
    "GenZPhoton_pz":          {"name":"GenZPhoton_pz",        "title":"Gen photon_{0} p_{z} [GeV]",                   "bin":100,"xmin":0 ,"xmax":50}, #UPDATE
    "GenZPhoton_eta":         {"name":"GenZPhoton_eta",       "title":"Gen photon_{0} #eta",                          "bin":60, "xmin":-3,"xmax":3}, #UPDATE
    "GenZPhoton_theta":       {"name":"GenZPhoton_theta",     "title":"Gen photon_{0} #theta",                        "bin":64, "xmin":0,"xmax":3.2}, #UPDATE
    "GenZPhoton_phi":         {"name":"GenZPhoton_phi",       "title":"Gen photon_{0} #phi",                          "bin":64, "xmin":-3.2,"xmax":3.2}, #UPDATE
    ...
    "GenALPPhotons_alpha":    {"name":"GenALPPhotons_alpha",    "title":"Gen photons #alpha",                       "bin":64, "xmin":-3.2,"xmax":3.2}, #UPDATE
