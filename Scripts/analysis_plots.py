...
energy         = 91
collider       = 'FCC-ee'
inputDir       = "mydir" + "output_finalSel/"
#formats        = ['png','pdf']
formats        = ['pdf']
yaxis          = ['lin','log']
stacksig       = ['nostack']
...
extralabel['sel2'] = "Selection: FS_Photon energy > 5 GeV, 0 FS_Electrons"

colors = {}
colors['process_name'] = ROOT.kRed
#colors['Zee'] = ROOT.kBlue
#colors['gammagamma'] = ROOT.kGreen
...
plots['ALP'] = {'signal':{
    ...
    ['process_name'],
                ...
                'backgrounds':{},
                #'Zee':['p8_ee_Zee_ecm91'],
                #'gammagamma':['wzp6_ee_gammagamma_ecm91']}
}
...
#legend['gammagamma'] = 'e^{+}e^{-} #rightarrow #gamma #gamma'
